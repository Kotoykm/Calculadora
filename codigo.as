...
//11-09-2018
var num_inicial:Number = 0;
var num_final:Number = 0;
...
var fondopantalla:TextField = new TextField;
...
var formatopantalla:TextFormat = new TextFormat;
...
formatopantalla.size = 45;
formatopantalla.bold = true;
formatopantalla.color = 0xff8ba0;
formatopantalla.italic = false; 
formatopantalla.font = "Century Gothic";
...
addChild(fondopantalla);

fondopantalla.x=260;
fondopantalla.y=125;
fondopantalla.width=250;
fondopantalla.height=60;
fondopantalla.background = true;
fondopantalla.backgroundColor = 0xFDFBFC;
fondopantalla.mouseEnabled = false;


texti.defaultTextFormat = formatopantalla;
...
function igual(event:MouseEvent):void{
	...
	if(num_inicial > 0 && num_inicial ==0){
		texti.text = String(num_inicial);
	}
...
function limpiar(event:MouseEvent):void{
	...
	//Aca se ponen las desactivaciones
...
function insertar_uno(event:MouseEvent):void{
	...
	else if (Number(texti.text) == resultado){
		texti.text = "1";
		num_inicial = 0;
		num_final = 0;
	}
	...
	if(num_inicial == 0){
		...
		topmen.mouseEnabled = true;
		topmul.mouseEnabled = true;
		tecladiv.mouseEnabled = true;
	}
	else{
		teclamas.mouseEnabled = false;
